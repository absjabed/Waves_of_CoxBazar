...
public class CustomAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.list_item_hospital, null);
			holder = new ViewHolder();

			holder.hospital_name = (TextView) convertView.findViewById(R.id.hospital_name);
			holder.hospital_pic = (ImageView) convertView.findViewById(R.id.hospital_pic);
			holder.hospital_email = (TextView) convertView.findViewById(R.id.hospital_email);
			holder.hospital_mobile = (TextView) convertView.findViewById(R.id.hospital_mobile);
