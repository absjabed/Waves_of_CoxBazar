...
public class Hotel_CustomAdapter extends BaseAdapter {

	Context context;
	List<Hotel_Item> rowItems;

	Hotel_CustomAdapter(Context context, List<Hotel_Item> rowItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.hospital_pic = (ImageView) convertView.findViewById(R.id.hotel_demo_pic);

			Hotel_Item  row_pos = rowItems.get(position);
